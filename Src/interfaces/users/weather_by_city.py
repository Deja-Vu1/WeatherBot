...
def user_interface(bot,dictofdays):
    ...
    async def weather(ctx,*args):
        ...
        if a["cod"] == 200 and a["list"] != []:
            ...
            embed2.set_footer(text=footext+" • bugün saat "+str(now_turkey.hour)+":"+str(minute), icon_url="https://cdn.discordapp.com/avatars/596455467585110016/b96ac044a4382f62ad36637c6021ef80.png?size=256")
